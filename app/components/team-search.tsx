...
export default function TeamSearchCell({
    ...
    value: string;
    allTeams: Array<{ id: number; name: string, participations: number, gold: number, silver: number, bronze: number }>;
    onFocus: () => void;
    onPick: (t: { id: number; name: string }) => void;
    ...
    function pickTeam(t : {id: number, name: string}){
        onPick(t)
    }
